        ...
        <SidebarProvider>
            <div className="min-h-screen">
                <div className="max-w-[1400px] mx-auto relative">
                    <div className="flex">
                        <Sidebar className="w-64 border-r hidden md:block fixed h-screen overflow-y-scroll flex-shrink-0 max-w-[1400px] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
