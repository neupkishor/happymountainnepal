...
>(
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn("group peer text-card-foreground", className)}
        data-state={state}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-4", isMobile && "p-2 pb-0", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2", isMobile && "p-1", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col px-2", isMobile && "px-1", className)}
      {...props}
    />
  )
})
  ...
  (
    ...
    const buttonContent = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), isMobile && "h-7 gap-1.5", className)}
        {...props}
      />
    );
